...
public class Device implements Serializable {
     ...
     * @param data
     */
    public void setBaoJingYaLiSetting(float data) {
     ...
     * @param data
     */
    public void setTingLuYaLiSetting(float data) {
     ...
     * @param data
     */
    public void setQiLuYaLiSetting(float data) {
     ...
     * @param data
     */
    public void setQiLuHuiChaYaLiSetting(float data) {
     ...
     * @param data
     */
    public void setZhengQiYaLi(float data) {
        zhengqiyali = data;
    }
     ...
     * @param data
     */
    public void setJiShuiYaLi(float data) {
        jishuiyali = data;
    }
     ...
     * @param data
     */
    public void setChuKouYaLi(float data) {
        chukouyali = data;
    }
     ...
     * @param data
     */
    public void setRuKouYaLi(float data) {
        rukouyali = data;
    }
     ...
     * @param data
     */
    public void setLuTangYaLi(float data) {
        lutangyali = data;
    }
     ...
     * @param data
     */
    public void setLuTangChuKouYaLi(float data) {
     ...
     * @param data
     */
    public void setRanQiYaLi(float data) {
        ranqiyali = data;
    }
     ...
     * @param data
     */
    public void setYiCiFengYa(float data) {
        yicifengya = data;
    }
     ...
     * @param data
     */
    public void setECiFengYa(float data) {
        ecifengya = data;
    }
     ...
     * @param data
     */
    public void setPaiYanYangHanLiang(float data) {
        ...
        for (SettingConfig conf : config.getSetting()) {
            if (this.getPower() == conf.getPower() && this.getMedia() == conf.getMedia()) {
                ...
                try {
                    ...
                    this.focusItem2 = field.getFloat(this);
